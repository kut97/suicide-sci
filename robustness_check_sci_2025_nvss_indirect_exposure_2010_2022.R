...
#  COVID-19, drug overdose (substance-use proxy; occurrence-based, matching
#  how this script builds the suicide outcome; EXCLUDES X60-X64), County
#  Health Rankings mental-health measures + EXCESSIVE DRINKING (alcohol
#  proxy, CHR v049), and RAND state firearm policies.
...
## (b) Drug-overdose deaths per 100k (occurrence-based, matches this script's
##     suicide outcome; EXCLUDES X60-X64 which are already in that outcome) --
